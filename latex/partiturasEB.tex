...
\musica{Carinhoso}
\includepdf{../PDF/EB/carinhoso.pdf}
...
\musica{Allah-La Ô}
\includepdf{../PDF/EB/allahlao.pdf}
\musica{Aurora}
...
\includepdf{../PDF/EB/chiquitaBacana.pdf}
\musica{Cidade Maravilhosa}
\includepdf{../PDF/EB/cidadeMaravilhosa.pdf}
...
\includepdf{../PDF/EB/poRoyal.pdf}

\capitulo{AXÉ}
\input{../capas/axe}
%\musica{A dança do bum bum}
\musica{A Luz de Tieta}
\includepdf{../PDF/EB/luzTieta.pdf}
%\musica{Água Mineral}
%\musica{Alô Paixão}
...
\musica{Haja Amor}
\includepdf{../PDF/EB/hajaAmor.pdf}
...
\includepdf{../PDF/EB/odisseia.pdf}
\musica{Carroça de Fogo}
\includepdf{../PDF/EB/carroca.pdf}
