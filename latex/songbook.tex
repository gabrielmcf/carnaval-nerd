...
\usepackage[top=1cm,left=.2cm,right=.2cm,bottom=.4cm,footskip=2cm]{geometry}
\usepackage{titletoc}
%\usepackage{titlesec}
...
{\addvspace{.8em}\bf} %formatação do título e espaço vertical antes
{} %formato de número
...
{\hspace*{0em}\sc\small\contentsmargin{-4em}} %formatação do título e espaço vertical antes
{} %formato de número
